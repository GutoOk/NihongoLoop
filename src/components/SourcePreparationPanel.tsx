    ...
    <div className="bg-white border-b border-[#E5E5E7] p-6 flex flex-col items-center">
      <div className="w-full max-w-5xl bg-slate-50 border border-slate-200 rounded-3xl p-6 sm:p-8 relative">
        ...
        {isRunning && !localRunnerActive && (
          <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-2xl flex flex-col gap-3 text-left animate-in fade-in">
            <div className="text-xs text-amber-800 font-medium leading-relaxed flex items-center gap-1.5">
              ...
              Status de Processamento Ativo nos registros, mas suspenso neste
              dispositivo.
            </div>
        ...
        <div className="mt-8 pt-8 border-t border-slate-200 text-left">
          ...
          {jobs.length > 0 && (
            <div className="flex flex-wrap gap-2.5 mb-5 p-3 bg-slate-100/80 rounded-2xl border border-slate-200/50 items-center">
              {/* Play Button */}
              <button
                onClick={async () => {
                ...
                title="Iniciar ou retomar processamento da fila com 30 requisições simultâneas"
              >
              ...
              <button
                ...
                className="px-4 py-2 bg-white hover:bg-rose-50 border border-slate-200 hover:border-rose-200 text-rose-600 font-bold text-xs uppercase tracking-wider rounded-xl transition-all flex items-center gap-2 shadow-sm cursor-pointer ml-auto"
